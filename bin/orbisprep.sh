...
OphCiPatientdischarge
OphTrOperationnote
OphMiScan
OphCiPatientadmission
OphCiAnaestheticassessment
OphCiAnaesthesiadischarge
OphInBiometry
" > .enabled-modules
...
# Import orbis
vagrant ssh -c '/usr/bin/mysql -u openeyes -poe_test openeyes < /var/www/features/orbis.sql;'
