<div class="element_field">
	...
	<?php
	$field_types = array('Textbox','Decimal','Integer','Textarea','Date picker','Dropdown list','Textarea with dropdown','Checkbox','Checkbox collection', 'Radio buttons','Boolean','Multi select','Slider');
