...
<div class="box admin">
	...
	$form = $this->beginWidget('BaseEventTypeCActiveForm', array(
		...
		<?php echo $form->multiSelectList($user, 'roles', 'roles', 'name', CHtml::listData(Yii::app()->authManager->getRoles(), 'name', 'name'), array(), array('label' => 'Roles', 'empty' => '-- Add --'), false, false, null, false, false, array(), false, false, 'name')?>
