				...
				<div class="row data-row">
					...
					<div class="large-8 column">
						<div class="data-value" id="gp_name">
							<?php echo $gp->contact ? $gp->contact->fullName : 'Unknown';
								if ($gp->contact) {?>
					...
					<div class="row data-row highlight">
						...
						<div class="large-8 column">
							<div class="data-value" id="gp_address">
								<?php echo $gp->contact && $gp->contact->address ? $gp->contact->address->letterLine : 'Unknown'?>
							</div>
						</div>
					</div>
					<div class="row data-row highlight">
						...
						<div class="large-8 column">
							<div class="data-value" id="gp_telephone">
								<?php echo $gp->contact && $gp->contact->primary_phone ? $gp->contact->primary_phone : 'Unknown'; ?>
							</div>
						</div>
					</div>
				<?php } ?>
				...
				<div class="row data-row">
					...
					<div class="large-8 column">
						<div class="data-value" id="gp_practice_address">
							<?php echo $practice->contact && $practice->contact->address ? $practice->contact->address->letterLine : 'Unknown'; ?>
							<?php if ($practice->contact && $practice->contact->address) {?>
				...
				<div class="row data-row">
					...
					<div class="large-8 column">
						<div class="data-value" id="gp_practice_telephone">
							<?php echo $practice->phone ? $practice->phone : 'Unknown'; ?>
						</div>
					</div>
				</div>
