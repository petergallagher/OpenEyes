...
class SubspecialtyService extends DeclarativeModelService
{
	...
	static protected $primary_model = 'Subspecialty';
	...
	static public $model_map = array(
		'Subspecialty' => array(
			'fields' => array(
				'name' => 'name',
				'ref_spec' => 'ref_spec',
				'specialty_ref' => array(self::TYPE_REF, 'specialty_id', 'Specialty'),
			),
		),
	);
