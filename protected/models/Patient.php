	...
	*/
	public function relations()
	{
		return array(
			...
			'allergies' => array(self::HAS_MANY, 'Allergy', 'allergy_id', 'through' => 'allergyAssignments', 'alias' => 'patient_allergies', 'order' => 'patient_allergies.name'),
			...
			'commissioningbodies' => array(self::HAS_MANY, 'CommissioningBody', 'commissioning_body_id', 'through' => 'commissioningbody_assignments'),
			'commissioningbody_assignments' => array(self::HAS_MANY, 'CommissioningBodyPatientAssignment', 'patient_id'),
